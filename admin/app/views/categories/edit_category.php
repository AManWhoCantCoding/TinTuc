...
if(!Session::check('admin_id')):
  // chuyển hướng về trang trước, sau đó tự động đến trang đăng nhập nếu chưa có Session
  $path->redirect('../');
endif;
$format->page_name = 'Chỉnh sửa thể loại';
    ...
    <div class="row">
      <div class="form-box" style="width: 600px; text-align: center; margin: auto;">
        ...
        <form action="<?php echo ADMINSITE; ?>/categories/edit_msg" method="POST" enctype="multipart/form-data" style="width: 100%">
          ...
          <div class="form-group">
            <label>Mô tả:</label>
            <textarea class="form-control" type="text" name="description" placeholder="Nhập mô tả"><?php if(isset($data['row']['description'])){echo $data['row']['description']; } ?></textarea>
