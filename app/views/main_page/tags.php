...
ob_start();
include IINT_VIEWS;
$format->page_title = 'thẻ'; // tiêu đề trang
include $tpl . 'header.php';

// Xử lý phân trang khi có tham số ?page=
if(isset($_GET['page'])){
  $page = $_GET['page'];
  $tag = $this->getUrl()[2];
  $results_per_page = 3;
...
<div class="main-body cat_main_body">
  <div class="container">
     <h2 class="header">
       <?php echo  $this->getUrl()[2]; // tên thẻ ?>
     </h2>
     <div class="row">
          ...
          <div class="col-md-3">
            <div class="latest-news">
                ...
                <div class="news-box-body">
                  ...
                  <a href="<?php echo BASEURL; ?>/post/single/<?php echo $id; ?>" class="read-more">Xem thêm</a>
      ...
      <?php else: ?>
        <div class="alert alert-danger">Hiện chưa có bài viết nào cho thẻ này.</div>
      <?php endif; ?>
     ...
     <div class="order-list">
       <ul class="list-unstyled">
         <?php for($page = 1; $page <= $number_of_page; $page++) { ?>
            <li>
              <a href="<?php echo BASEURL; ?>/tags/posts/<?php echo $this->getUrl()[2]; ?>/?page=<?php echo $page; ?>">
                <?php echo $page; ?>
              </a>
            </li>
         <?php } ?>
